exports.isConditionMet = function isConditionMet(condition, data) {
...
exports.areAllConditionsMet = function areAllConditionsMet(data, rule) {
  let result = true
...
exports.executeAutomationRule = function executeAutomationRule(data, rule) {
  if (areAllConditionsMet(data, rule)) rule.action(data)
}

exports.executeAllAutomationRules = function executeAllAutomationRules(
  data,
  rules
) {
